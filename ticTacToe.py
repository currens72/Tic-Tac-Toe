...
def reset():
    global x, box1, box2, box3, box4, box5, box6, box7, box8, box9
    x = 2
    box1 = [0, 0, 0]
    box2 = [0, 0, 0]
    box3 = [0, 0, 0]
...
while running:
    ...
    pygame.draw.rect(screen, red, pygame.Rect(250, 610, 100, 30), 1)
    screen.blit(resetText, (275, 615))

    if box1[1] == 1:
        if box1[2] % 2 == 1:
            pygame.draw.circle(screen, black, (100, 100), 75, 1)
        else:
            pygame.draw.line(screen, black, (25, 25), (175, 175))
            pygame.draw.line(screen, black, (175, 25), (25, 175))
    if box2[1] == 1:
        if box2[2] % 2 == 1:
            pygame.draw.circle(screen, black, (300, 100), 75, 1)
        else:
            pygame.draw.line(screen, black, (225, 25), (375, 175))
            pygame.draw.line(screen, black, (375, 25), (225, 175))
    if box3[1] == 1:
        if box3[2] % 2 == 1:
            pygame.draw.circle(screen, black, (500, 100), 75, 1)
        else:
            pygame.draw.line(screen, black, (425, 25), (575, 175))
            pygame.draw.line(screen, black, (575, 25), (425, 175))
    if box4[1] == 1:
        if box4[2] % 2 == 1:
            pygame.draw.circle(screen, black, (100, 300), 75, 1)
        else:
            pygame.draw.line(screen, black, (25, 225), (175, 375))
            pygame.draw.line(screen, black, (175, 225), (25, 375))
    if box5[1] == 1:
        if box5[2] % 2 == 1:
            pygame.draw.circle(screen, black, (300, 300), 75, 1)
        else:
            pygame.draw.line(screen, black, (225, 225), (375, 375))
            pygame.draw.line(screen, black, (375, 225), (225, 375))
    if box6[1] == 1:
        if box6[2] % 2 == 1:
            pygame.draw.circle(screen, black, (500, 300), 75, 1)
        else:
            pygame.draw.line(screen, black, (425, 225), (575, 375))
            pygame.draw.line(screen, black, (575, 225), (425, 375))
    if box7[1] == 1:
        if box7[2] % 2 == 1:
            pygame.draw.circle(screen, black, (100, 500), 75, 1)
        else:
            pygame.draw.line(screen, black, (25, 425), (175, 575))
            pygame.draw.line(screen, black, (175, 425), (25, 575))
    if box8[1] == 1:
        if box8[2] % 2 == 1:
            pygame.draw.circle(screen, black, (300, 500), 75, 1)
        else:
            pygame.draw.line(screen, black, (225, 425), (375, 575))
            pygame.draw.line(screen, black, (375, 425), (225, 575))
    if box9[1] == 1:
        if box9[2] % 2 == 1:
            pygame.draw.circle(screen, black, (500, 500), 75, 1)
        else:
            pygame.draw.line(screen, black, (425, 425), (575, 575))
            pygame.draw.line(screen, black, (575, 425), (425, 575))

    #HORIZONTAL WINS
    if box3[2] % 2 == box2[2] % 2 == box1[2] % 2 and box3[2] != 0 and box2[2] != 0 and box1[2] != 0 :
        if box3[2] % 2 == 1:
            screen.blit(oWinText, (120, 250))
        else:
            screen.blit(xWinText, (120, 250))
